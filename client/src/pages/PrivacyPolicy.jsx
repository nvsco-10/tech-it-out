  ...
  return (
    <>
      ...
      <section className="container">
        <div className="mb-6">
          <h1 className="title has-text-centered mb-6">Privacy Policy</h1>

          <p className="mb-2">
            Tech It Out operates the techitout.com website, which provides the
            SERVICE.
          </p>
          ...
          <p className="mb-2">
            ...
            anyone decided to use our Service, the Tech It Out website.
          </p>
          ...
          <p className="mb-2">
            ...
            our Terms and Conditions, which is accessible at techitout.com,
            unless otherwise defined in this Privacy Policy.
          </p>

          <h2 className="title is-5 mt-4">Information Collection and Use</h2>
          ...
          <h2 className="title is-5 mt-4">Log Data</h2>
          ...
          <h2 className="title is-5 mt-4">Cookies</h2>
          ...
          <h2 className="title is-5 mt-4">Service Providers</h2>
          ...
          <h2 className="title is-5 mt-4">Security</h2>
          ...
          <h2 className="title is-5 mt-4">Links to Other Sites</h2>
          ...
          <h2 className="title is-5 mt-4">Children's Privacy</h2>
          ...
          <h2 className="title is-5 mt-4">Changes to This Privacy Policy</h2>
          ...
          <h2 className="title is-5 mt-4">Contact Us</h2>

          <p className="mb-2">
            If you have any questions or suggestions about our Privacy Policy,
            do not hesitate to contact us at questions@techitout.com.
          </p>
        </div>
      </section>
    </>
