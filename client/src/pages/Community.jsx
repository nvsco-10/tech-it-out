      ...
      <div>
        ...
        <div className="section2 has-text-centered">
          ...
          <div className="comm-tag mt-2 mb-5">
            <p>FILTER:</p>
            <button className="button m-4 is-info" onClick={filterByCategory}>
              SHOW OFF
            </button>
            <button className="button m-4 is-danger" onClick={filterByCategory}>
              HELP ME
            </button>
            <button
              className="button m-4 is-warning"
              onClick={filterByCategory}
            >
              MENTORSHIP
            </button>
            <button
              className="button m-4 is-success"
              onClick={filterByCategory}
            >
              BUDDY
            </button>
